...
```
canvas action:present node:mac-63599bc4-b54d-4392-9048-b97abd58343a target:http://peters-mac-studio-1.sheep-coho.ts.net:18793/__genosos__/canvas/snake.html
```
...
```
http://<host>:18793/__genosos__/canvas/index.html  → ~/clawd/canvas/index.html
http://<host>:18793/__genosos__/canvas/games/snake.html → ~/clawd/canvas/games/snake.html
```
