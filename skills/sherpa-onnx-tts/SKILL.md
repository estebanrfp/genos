...
1. Download the runtime for your OS (extracts into `~/.genosv1/tools/sherpa-onnx-tts/runtime`)
2. Download a voice model (extracts into `~/.genosv1/tools/sherpa-onnx-tts/models`)

Update `~/.genosv1/genosos.json`:
...
```json5
{
  skills: {
    entries: {
      "sherpa-onnx-tts": {
        env: {
          SHERPA_ONNX_RUNTIME_DIR: "~/.genosv1/tools/sherpa-onnx-tts/runtime",
          SHERPA_ONNX_MODEL_DIR: "~/.genosv1/tools/sherpa-onnx-tts/models/vits-piper-en_US-lessac-high",
        },
      },
    },
  },
