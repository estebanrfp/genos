let createMockRequest = function (method, url, body, opts) {
  ...
  createMockContext = function (overrides) {
    return {
  ...
  mockSuccessfulProfileImport = function () {
...
describe("nostr-profile-http", () => {
  ...
  describe("PUT /api/channels/nostr/:accountId/profile", () => {
    ...
    it("rejects non-https URLs", async () => {
      ...
      expect(data.details.some((d) => d.includes("https"))).toBe(true);
    });
