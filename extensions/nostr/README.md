...
Nostr DM channel plugin for GenosOS using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to GenosOS. It enables your bot to:
...
# Configure genosos to use local relay
