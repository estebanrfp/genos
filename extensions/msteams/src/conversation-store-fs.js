let parseTimestamp = function (value) {
    if (!value) {
      return null;
    }
  ...
  pruneToLimit = function (conversations) {
  ...
  pruneExpired = function (conversations, nowMs, ttlMs) {
    let removed = false;
    const kept = {};
  ...
  normalizeConversationId = function (raw) {
...
const CONVERSATION_TTL_MS = 31536000000;
