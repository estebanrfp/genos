let setMSTeamsDmPolicy = function (cfg, dmPolicy) {
    const allowFrom =
      dmPolicy === "open"
  ...
  setMSTeamsAllowFrom = function (cfg, allowFrom) {
    return {
      ...cfg,
      channels: {
        ...cfg.channels,
  ...
  looksLikeGuid = function (value) {
    return /^[0-9a-fA-F-]{16,}$/.test(value);
  },
  setMSTeamsGroupPolicy = function (cfg, groupPolicy) {
    return {
      ...cfg,
      channels: {
        ...cfg.channels,
  ...
  setMSTeamsTeamsAllowlist = function (cfg, entries) {
