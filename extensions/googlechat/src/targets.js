let stripMessageSuffix = function (target) {
...
export function normalizeGoogleChatTarget(raw) {
...
export function isGoogleChatUserTarget(value) {
  return value.toLowerCase().startsWith("users/");
}
export function isGoogleChatSpaceTarget(value) {
