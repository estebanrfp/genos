...
import { GoogleChatConfigSchema } from "genosos/plugin-sdk";
import {
...
export const googlechatDock = {
  ...
  config: {
    resolveAllowFrom: ({ cfg, accountId }) =>
      (resolveGoogleChatAccount({ cfg, accountId }).config.dm?.allowFrom ?? []).map((entry) =>
        String(entry),
      ),
