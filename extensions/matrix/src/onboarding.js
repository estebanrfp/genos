let setMatrixDmPolicy = function (cfg, policy) {
    const allowFrom =
  ...
  setMatrixGroupPolicy = function (cfg, groupPolicy) {
    return {
      ...cfg,
      channels: {
        ...cfg.channels,
  ...
  setMatrixGroupRooms = function (cfg, roomKeys) {
  ...
  configure: async ({ cfg, runtime, prompter, forceAllowFrom }) => {
    ...
    const deviceName = String(
      await prompter.text({
        ...
        initialValue: existing.deviceName ?? "GenosOS Gateway",
      }),
    ).trim();
