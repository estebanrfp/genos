...
export function summarizeMatrixRawEvent(event) {
...
export async function readPinnedEvents(client, roomId) {
  try {
    const content = await client.getRoomStateEvent(roomId, EventType.RoomPinnedEvents, "");
...
export async function fetchEventSummary(client, roomId, eventId) {
  try {
