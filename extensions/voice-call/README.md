...
Official Voice Call plugin for **GenosOS**.
...
Docs: `https://docs.genos.ai/plugins/voice-call`
Plugin system: `https://docs.genos.ai/plugin`

## Install (local dev)

### Option A: install via GenosOS (recommended)
...
```bash
mkdir -p ~/.genosv1/extensions
cp -R extensions/voice-call ~/.genosv1/extensions/voice-call
cd ~/.genosv1/extensions/voice-call && pnpm install
```
...
genosos voicecall speak --call-id <id> --message "One moment"
genosos voicecall end --call-id <id>
genosos voicecall status --call-id <id>
genosos voicecall tail
