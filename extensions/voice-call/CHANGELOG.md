...
- Version alignment with core GenosOS release numbers.
...
- First public release of the @genosos/voice-call plugin.
...
- CLI: `genosos voicecall` commands (call/start/continue/speak/end/status/tail/expose).
