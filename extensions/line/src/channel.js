...
export const linePlugin = {
  ...
  pairing: {
    ...
    notifyApproval: async ({ cfg, id }) => {
      ...
      await line.pushMessageLine(id, "GenosOS: your access has been approved.", {
  ...
  security: {
    resolveDmPolicy: ({ cfg, accountId, account }) => {
      ...
      const useAccountPath = Boolean(cfg.channels?.line?.accounts?.[resolvedAccountId]);
      ...
      return {
        ...
        approveHint: "genosos pairing approve line <code>",
