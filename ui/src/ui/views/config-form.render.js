let getSectionIcon = function (key) {
  ...
  matchesSearch = function (key, schema, query) {
    if (!query) {
      return true;
    }
  ...
  schemaMatches = function (schema, query) {
...
import { hintForPath, schemaType } from "./config-form.shared.js";
const sectionIcons = {
  env: html`
...
export const SECTION_META = {
  ...
  providers: {
    label: "Providers",
    description: "AI provider credentials, endpoints, model lists, and failover order",
  },
  channels: {
    label: "Channels",
