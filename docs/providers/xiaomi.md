---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with GenosOS"
read_when:
  - You want Xiaomi MiMo models in GenosOS
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). GenosOS uses
...
```bash
genosos onboard --auth-choice xiaomi-api-key
# or non-interactive
genosos onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
