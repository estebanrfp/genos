---
summary: "Use Qianfan's unified API to access many models in GenosOS"
read_when:
...
3. GenosOS installed on your system
...
4. Copy the API key for use with GenosOS

## CLI setup

```bash
genosos onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [GenosOS Configuration](/gateway/configuration)
