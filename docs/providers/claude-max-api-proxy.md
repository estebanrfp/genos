...
You can point GenosOS at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or GenosOS
...
- [Anthropic provider](/providers/anthropic) - Native GenosOS integration with Claude setup-token or API keys
