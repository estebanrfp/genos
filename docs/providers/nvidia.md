---
summary: "Use NVIDIA's OpenAI-compatible API in GenosOS"
read_when:
  - You want to use NVIDIA models in GenosOS
...
genosos onboard --auth-choice skip
genosos models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
