---
summary: "Use Qwen OAuth (free tier) in GenosOS"
read_when:
  - You want to use Qwen with GenosOS
...
```bash
genosos models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, GenosOS will sync credentials
