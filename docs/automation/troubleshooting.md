...
genosos system heartbeat last
genosos logs --follow
genosos config get agents.defaults.heartbeat
genosos channels status --probe
```
...
```bash
genosos config get agents.defaults.heartbeat.activeHours
genosos config get agents.defaults.heartbeat.activeHours.timezone
genosos config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
genosos cron list
genosos logs --follow
```
