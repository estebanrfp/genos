...
- Install via CLI: `genosos plugins install @genosos/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `genosos plugins install ./extensions/zalo`
   - From npm (if published): `genosos plugins install @genosos/zalo`
...
- Approve via:
  - `genosos pairing list zalo`
  - `genosos pairing approve zalo <CODE>`
...
- Example: `genosos message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `genosos channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `genosos logs --follow`
