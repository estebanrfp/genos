---
title: IRC
description: Connect GenosOS to IRC channels and direct messages.
---

Use IRC when you want GenosOS in classic channels (`#room`) and direct messages.
IRC ships as an extension plugin, but it is configured in the main config under `channels.irc`.

## Quick start

1. Enable IRC config in `~/.genosv1/genosos.json`.
2. Set at least:
...
Even if a channel is allowed (via `groupPolicy` + `groups`) and the sender is allowed, GenosOS defaults to **mention-gating** in group contexts.
