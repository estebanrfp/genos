...
GenosOS treats group chats consistently across surfaces: WhatsApp, Telegram, Discord, Slack, Signal, iMessage, Microsoft Teams.

## Beginner intro (2 minutes)

GenosOS “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, GenosOS can see that group and respond there.
...
Translation: allowlisted senders can trigger GenosOS by mentioning it.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@genosos", "genosos", "\\+15555550123"],
          historyLimit: 50,
        },
      },
    ],
