---
summary: "Overview of GenosOS onboarding options and flows"
read_when:
...
GenosOS supports multiple onboarding paths depending on where the Gateway runs
...
- [`genosos onboard` command](/cli/onboard)

## macOS app onboarding

Use the GenosOS app when you want a fully guided setup on macOS. Docs:
