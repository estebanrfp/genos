---
summary: "First-run onboarding flow for GenosOS (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give GenosOS">
...
<Step title="CLI">
  ...
  The app can install the global `genosos` CLI via npm/pnpm so terminal
