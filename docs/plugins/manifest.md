...
read_when:
  - You are building a GenosOS plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (genosos.plugin.json)

Every plugin **must** ship a `genosos.plugin.json` file in the **plugin root**.
GenosOS uses this manifest to validate configuration **without executing plugin
