...
This guide summarizes a sane workflow for working on the pi integration in GenosOS.
...
- Trigger the agent directly:
  - `pnpm genosos agent --message "Hello" --thinking low`
...
State lives under the GenosOS state directory. Default is `~/.genos`. If `GENOS_STATE_DIR` is set, use that directory instead.

To reset everything:

- `genosos.json` for config
...
- [https://docs.genos.ai/testing](https://docs.genos.ai/testing)
- [https://docs.genos.ai/start/getting-started](https://docs.genos.ai/start/getting-started)
