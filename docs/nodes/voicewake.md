...
GenosOS treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.genosv1/settings/voicewake.json`

Shape:

```json
{ "triggers": ["genosos", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
