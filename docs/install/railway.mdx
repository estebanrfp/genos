...
Deploy GenosOS on Railway with a one-click template and finish setup in your browser.
...
<a href="https://railway.com/deploy/genosos-railway-template" target="_blank" rel="noreferrer">
  Deploy on Railway
</a>
...
- `https://<your-railway-domain>/genosos` — Control UI

## What you get

- Hosted GenosOS Gateway + Control UI
...
- `GENOS_STATE_DIR=/data/.genos` (recommended)
- `GENOS_WORKSPACE_DIR=/data/workspace` (recommended)
- `GENOS_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your GenosOS state + workspace so you can migrate to another host without losing config or memory.
