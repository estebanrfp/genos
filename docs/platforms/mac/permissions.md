...
- Same path: run the app from a fixed location (for GenosOS, `dist/GenosOS.app`).
...
Workaround: move files into the GenosOS workspace (`~/.genosv1/workspace`) if you want to avoid per-folder grants.
