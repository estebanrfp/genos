let addBeforeModelResolveHook = function (registry, pluginId, handler, priority) {
  ...
  addBeforePromptBuildHook = function (registry, pluginId, handler, priority) {
    registry.typedHooks.push({
      pluginId,
  ...
  addLegacyBeforeAgentStartHook = function (registry, pluginId, handler, priority) {
    registry.typedHooks.push({
      pluginId,
