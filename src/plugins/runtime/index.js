  ...
  return {
    ...
    channel: {
      ...
      pairing: {
        ...
        clearAllowFromStore: clearChannelAllowFromStore,
        clearPairingRequests: clearChannelPairingRequests,
