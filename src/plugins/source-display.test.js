...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/genosos/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/genosos/extensions",
        global: "/Users/x/.genos/extensions",
        workspace: "/Users/x/ws/.genos/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.genos/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/genosos/extensions",
        global: "/Users/x/.genos/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.genos/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/genosos/extensions",
        global: "/Users/x/.genos/extensions",
