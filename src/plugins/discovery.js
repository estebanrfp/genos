let isExtensionFile = function (filePath) {
  ...
  readPackageManifest = function (dir) {
  ...
  resolvePackageExtensions = function (manifest) {
  ...
  discoverInDirectory = function (params) {
  ...
  discoverFromPath = function (params) {
...
export function discoverGenosOSPlugins(params) {
  const candidates = [];
  const diagnostics = [];
  const seen = new Set();
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".genosv1", "extensions")];
