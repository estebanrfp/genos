...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@genosos", { botUsername: "genosos" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@genosos args", {
        botUsername: "genosos",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "genosos" })).toBe(
      "/help@otherbot",
    );
  });
...
describe("commands registry args", () => {
  function createUsageModeCommand(argsParsing = "positional", description = "mode") {
    return {
      key: "usage",
      description: "usage",
      textAliases: [],
  ...
  it("resolves auto arg menus when missing a choice arg", () => {
    ...
    const menu = resolveCommandArgMenu({ command, args: undefined, cfg: {} });
