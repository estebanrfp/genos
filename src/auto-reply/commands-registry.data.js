let defineChatCommand = function (command) {
  ...
  defineDockCommand = function (dock) {
  ...
  registerAlias = function (commands, key, ...aliases) {
  ...
  assertCommandRegistry = function (commands) {
    const keys = new Set();
...
\u2022 Help \u2013 Show usage guide`,
      ...
      defineChatCommand({
        ...
        description: "List configured AI providers and credentials.",
        textAlias: "/providers",
        category: "tools",
      }),
      defineChatCommand({
