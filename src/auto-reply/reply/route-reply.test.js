...
const mocks = vi.hoisted(() => ({
  ...
  sendMessageMSTeams: vi.fn(async (_params) => ({
    messageId: "m1",
    conversationId: "c1",
  })),
...
vi.mock("../../infra/outbound/deliver.js", async () => {
  const actual = await vi.importActual("../../infra/outbound/deliver.js");
  return {
    ...actual,
    deliverOutboundPayloads: mocks.deliverOutboundPayloads,
  };
});
const actualDeliver = await vi.importActual("../../infra/outbound/deliver.js");
