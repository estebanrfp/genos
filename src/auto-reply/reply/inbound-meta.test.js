let parseInboundMetaPayload = function (text) {
  ...
  parseConversationInfoPayload = function (text) {
...
describe("buildInboundMetaSystemPrompt", () => {
  it("includes trusted message and routing ids for tool actions", () => {
    ...
    expect(payload["schema"]).toBe("genosos.inbound_meta.v1");
