let extractGroupId = function (raw) {
  ...
  resolveProviderLabel = function (rawProvider) {
...
export function buildGroupIntro(params) {
  ...
  const silenceLine =
    activation === "always"
      ? `If no response is needed, reply with exactly "${params.silentToken}" (and nothing else) so GenosOS stays silent. Do not add any other words, punctuation, tags, markdown/code blocks, or explanations.`
      : undefined;
  const cautionLine =
    activation === "always"
