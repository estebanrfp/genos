...
describe("createModelSelectionState parent inheritance", () => {
  ...
  async function resolveHeartbeatStoredOverrideState(hasResolvedHeartbeatModelOverride) {
    const cfg = {};
  ...
  it("inherits parent override from explicit parentSessionKey", async () => {
    const cfg = {};
    const parentKey = "agent:default:discord:channel:c1";
    const sessionKey = "agent:default:discord:channel:c1:thread:123";
  ...
  it("derives parent key from topic session suffix", async () => {
    const cfg = {};
    const parentKey = "agent:default:telegram:group:123";
    const sessionKey = "agent:default:telegram:group:123:topic:99";
    const parentEntry = makeEntry({
      providerOverride: "openai",
      modelOverride: "gpt-4o",
    });
  ...
  it("ignores parent override when disallowed", async () => {
    ...
    const parentKey = "agent:default:slack:channel:c1";
...
describe("createModelSelectionState respects session model override", () => {
  ...
  async function resolveState(sessionEntry) {
    const cfg = {};
