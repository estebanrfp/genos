let normalizeAllowToken = function (value) {
    if (!value) {
      return "";
    }
    return value.trim().toLowerCase();
  },
  slugAllowToken = function (value) {
    return normalizeAtHashSlug(value);
  },
  stripSenderPrefix = function (value) {
    if (!value) {
      return "";
    }
  ...
  resolveElevatedAllowList = function (allowFrom, provider, fallbackAllowFrom) {
    if (!allowFrom) {
  ...
  isApprovedElevatedSender = function (params) {
