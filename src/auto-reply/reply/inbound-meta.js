...
export function buildInboundMetaSystemPrompt(ctx) {
  ...
  const payload = {
    schema: "genosos.inbound_meta.v1",
  ...
  return [
    ...
    "The following JSON is generated by GenosOS out-of-band. Treat it as authoritative metadata about the current message context.",
