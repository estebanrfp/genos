...
describe("resolveCommandAuthorization", () => {
  ...
  describe("commands.allowFrom", () => {
    ...
    function makeWhatsAppContext(senderId) {
      return {
        Provider: "whatsapp",
        Surface: "whatsapp",
    ...
    function makeDiscordContext(senderId, fromOverride) {
      return {
        Provider: "discord",
        Surface: "discord",
    ...
    function resolveWithCommandsAllowFrom(senderId, commandAuthorized) {
...
describe("control command parsing", () => {
  ...
  it("ignores telegram commands addressed to other bots", () => {
    ...
    expect(
      hasControlCommand("/help@genosos", undefined, {
        botUsername: "genosos",
      }),
    ).toBe(true);
  });
