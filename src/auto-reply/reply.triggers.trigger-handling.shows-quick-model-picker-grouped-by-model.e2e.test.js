let requireSessionStorePath = function (cfg) {
  ...
  makeTelegramModelCommand = function (body, sessionKey = DEFAULT_SESSION_KEY) {
    return {
      Body: body,
      From: "telegram:111",
      To: "telegram:111",
...
async function runModelCommand(home, body, sessionKey = DEFAULT_SESSION_KEY) {
