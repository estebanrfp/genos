let mockSuccessfulCompaction = function () {
...
describe("trigger handling", () => {
  it("runs /compact as a gated command", async () => {
    await withTempHome(async (home) => {
      const storePath = join(tmpdir(), `genosos-session-test-${Date.now()}.json`);
      ...
      expect(text?.startsWith("\u2699\uFE0F Compaction")).toBe(true);
