let isQmdNoResultsOutput = function (raw) {
    const lines = raw
      .split(/\r?\n/)
  ...
  isQmdNoResultsLine = function (line) {
  ...
  summarizeQmdStderr = function (raw) {
    return raw.length <= 120 ? raw : `${raw.slice(0, 117)}...`;
  },
  parseQmdQueryResultArray = function (raw) {
    try {
  ...
  extractFirstJsonArray = function (raw) {
