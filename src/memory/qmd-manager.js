let appendOutputWithCap = function (current, chunk, maxChars) {
...
import { readMemoryFile } from "./internal.js";
...
const MAX_QMD_OUTPUT_CHARS = 200000;
...
export class QmdMemoryManager {
  ...
  ensureDb() {
    ...
    this.db = openDatabase(this.indexPath);
