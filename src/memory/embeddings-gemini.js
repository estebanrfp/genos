let resolveRemoteApiKey = function (remoteApiKey) {
  ...
  normalizeGeminiModel = function (model) {
  ...
  normalizeGeminiBaseUrl = function (raw) {
  ...
  buildGeminiModelPath = function (model) {
