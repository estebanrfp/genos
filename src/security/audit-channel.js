let normalizeAllowFromList = function (list) {
    return normalizeStringEntries(Array.isArray(list) ? list : undefined);
  },
  classifyChannelWarningSeverity = function (message) {
  ...
  for (const plugin of params.plugins) {
    ...
    if (plugin.id === "slack") {
      ...
      const slashCommandEnabled =
        nativeEnabled || nativeSkillsEnabled || slackCfg.slashCommand?.enabled === true;
