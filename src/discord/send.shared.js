let normalizeReactionEmoji = function (raw) {
  ...
  normalizeStickerIds = function (raw) {
  ...
  normalizeEmojiName = function (raw, label) {
    const name = raw.trim();
    if (!name) {
  ...
  normalizeDiscordPollInput = function (input) {
  ...
  getDiscordErrorCode = function (err) {
