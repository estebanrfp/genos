let parseDiscordApiErrorPayload = function (text) {
  ...
  parseRetryAfterSeconds = function (text, response) {
  ...
  formatRetryAfterSeconds = function (value) {
  ...
  formatDiscordApiErrorText = function (text) {
    const trimmed = text.trim();
    if (!trimmed) {
      return;
    }
