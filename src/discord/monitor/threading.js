let getCachedThreadStarter = function (key, now) {
  ...
  setCachedThreadStarter = function (key, value, now) {
    DISCORD_THREAD_STARTER_CACHE.delete(key);
  ...
  isDiscordThreadType = function (type) {
    return (
...
const DISCORD_THREAD_STARTER_CACHE_TTL_MS = 300000;
