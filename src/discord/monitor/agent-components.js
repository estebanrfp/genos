let resolveAgentComponentRoute = function (params) {
  ...
  resolveDiscordChannelContext = function (interaction) {
  ...
  parseAgentComponentData = function (data) {
  ...
  isThreadChannelType = function (channelType) {
    return (
  ...
  normalizeComponentId = function (value) {
  ...
  parseDiscordComponentData = function (data, customId) {
    if (!data || typeof data !== "object") {
      return null;
    }
  ...
  parseDiscordModalId = function (data, customId) {
    if (data && typeof data === "object") {
      const rawModalId = "mid" in data ? data.mid : data.modalId;
  ...
  resolveInteractionCustomId = function (interaction) {
  ...
  mapOptionLabels = function (options, values) {
  ...
  mapSelectValues = function (entry, values) {
  ...
  resolveModalFieldValues = function (field, interaction) {
  ...
  formatModalSubmissionText = function (entry, interaction) {
