let summarizeAllowList = function (list) {
  ...
  summarizeGuilds = function (entries) {
  ...
  dedupeSkillCommandsForDiscord = function (skillCommands) {
    const seen = new Set();
    const deduped = [];
  ...
  formatDiscordDeployErrorDetails = function (err) {
