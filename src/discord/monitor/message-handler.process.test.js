let getLastRouteUpdate = function () {
...
const dispatchInboundMessage = vi.fn(async (_params) => ({
  queuedFinal: false,
...
const resolveStorePath = vi.fn(() => "/tmp/genosos-discord-process-test-sessions.json");
vi.mock("../send.js", () => ({
  reactMessageDiscord,
...
beforeEach(() => {
  ...
  resolveStorePath.mockReturnValue("/tmp/genosos-discord-process-test-sessions.json");
});
