let buildDiscordChannelKeys = function (params) {
  ...
  resolveDiscordChannelEntryMatch = function (channels, params, parentParams) {
  ...
  hasConfiguredDiscordChannels = function (channels) {
    return Boolean(channels && Object.keys(channels).length > 0);
  },
  resolveDiscordChannelConfigEntry = function (entry) {
    const resolved = {
