let createShortId = function (prefix) {
    return `${prefix}${crypto.randomBytes(6).toString("base64url")}`;
  },
  requireObject = function (value, label) {
    if (!value || typeof value !== "object" || Array.isArray(value)) {
      throw new Error(`${label} must be an object`);
    }
    return value;
  },
  readString = function (value, label, opts) {
  ...
  readOptionalString = function (value) {
    if (typeof value !== "string") {
      return;
    }
    const trimmed = value.trim();
  ...
  readOptionalStringArray = function (value, label) {
    if (value === undefined) {
      return;
    }
  ...
  readOptionalNumber = function (value) {
    if (typeof value !== "number" || !Number.isFinite(value)) {
      return;
    }
    return value;
  },
  normalizeModalFieldName = function (value, index) {
    const trimmed = value?.trim();
    if (trimmed) {
      return trimmed;
    }
  ...
  normalizeAttachmentRef = function (value, label) {
    const trimmed = value.trim();
        ...
        emoji:
          typeof obj.emoji === "object" && obj.emoji && !Array.isArray(obj.emoji)
            ? {
                ...
                animated: typeof obj.emoji.animated === "boolean" ? obj.emoji.animated : undefined,
              }
            : undefined,
  ...
  parseButtonSpec = function (raw, label) {
  ...
  parseSelectSpec = function (raw, label) {
    const obj = requireObject(raw, label);
  ...
  parseModalField = function (raw, label, index) {
    const obj = requireObject(raw, label);
  ...
  parseComponentBlock = function (raw, label) {
    const obj = requireObject(raw, label);
  ...
  buildTextDisplays = function (text, texts) {
  ...
  createButtonComponent = function (params) {
  ...
  createSelectComponent = function (params) {
  ...
  isSelectComponent = function (component) {
    return (
  ...
  createModalFieldComponent = function (field) {
    if (field.type === "text") {
    ...
    container:
      typeof obj.container === "object" && obj.container && !Array.isArray(obj.container)
        ? {
            ...
            spoiler: typeof obj.container.spoiler === "boolean" ? obj.container.spoiler : undefined,
          }
        : undefined,
    blocks,
    modal,
