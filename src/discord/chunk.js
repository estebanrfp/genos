let countLines = function (text) {
  ...
  closeFenceLine = function (openFence) {
    return `${openFence.indent}${openFence.markerChar.repeat(openFence.markerLen)}`;
  },
  closeFenceIfNeeded = function (text, openFence) {
    if (!openFence) {
      return text;
    }
  ...
  splitLongLine = function (line, maxChars, opts) {
  ...
  rebalanceReasoningItalics = function (source, chunks) {
    if (chunks.length <= 1) {
      return chunks;
    }
