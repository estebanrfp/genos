let resolveSessionKey = function ({ sessionKey, sessionId }) {
    return sessionKey ?? sessionId ?? "unknown";
  },
  findStateBySessionId = function (sessionId) {
...
const SESSION_STATE_TTL_MS = 1800000;
const SESSION_STATE_PRUNE_INTERVAL_MS = 60000;
