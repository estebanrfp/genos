let normalizeToken = function (value) {
  ...
  resolveLinkedPeerId = function (params) {
...
/** @deprecated Legacy alias — kept for backwards compatibility with existing sessions */
export const LEGACY_AGENT_ID = "main";
...
export function normalizeAgentId(value) {
  ...
  // Backwards compat: "main" → "default"
  if (lower === LEGACY_AGENT_ID) {
    return DEFAULT_AGENT_ID;
  }
