let normalizeToken = function (value) {
  ...
  matchesAccountId = function (match, actual) {
  ...
  listAgents = function (cfg) {
    const agents = cfg.agents?.list;
    return Array.isArray(agents) ? agents : [];
  },
  pickFirstExistingAgentId = function (cfg, agentId) {
  ...
  matchesChannel = function (match, channel) {
  ...
  getEvaluatedBindingsForChannelAccount = function (cfg, channel, accountId) {
  ...
  normalizePeerConstraint = function (peer) {
    if (!peer) {
      return { state: "none" };
    }
  ...
  normalizeBindingMatch = function (match) {
  ...
  hasGuildConstraint = function (match) {
    return Boolean(match.guildId);
  },
  hasTeamConstraint = function (match) {
    return Boolean(match.teamId);
  },
  hasRolesConstraint = function (match) {
    return Boolean(match.roles);
  },
  matchesBindingScope = function (match, scope) {
