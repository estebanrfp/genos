let buildDeliveryPatchFromLegacyPayload = function (payload) {
  ...
  mergeLegacyDeliveryInto = function (delivery, payload) {
  ...
  normalizePayloadKind = function (payload) {
  ...
  inferPayloadIfMissing = function (raw) {
  ...
  copyTopLevelAgentTurnFields = function (raw, payload) {
    let mutated = false;
  ...
  stripLegacyTopLevelFields = function (raw) {
    if ("model" in raw) {
      delete raw.model;
    }
    if ("thinking" in raw) {
