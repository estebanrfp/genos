let describeNode = function (nodeId) {
  ...
  logRemoteBinProbeFailure = function (nodeId, err) {
  ...
  isMacPlatform = function (platform, deviceFamily) {
  ...
  collectRequiredBins = function (entries, targetPlatform) {
    const bins = new Set();
