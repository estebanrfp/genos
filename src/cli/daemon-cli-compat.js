let parseExportAliases = function (bundleSource) {
  ...
  findRegisterContainerSymbol = function (bundleSource) {
...
export function resolveLegacyDaemonCliAccessors(bundleSource) {
