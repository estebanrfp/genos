let parseDevicePairingList = function (value) {
  ...
  selectLatestPendingRequest = function (pending) {
    if (!pending?.length) {
      return null;
    }
  ...
  formatTokenSummary = function (tokens) {
  ...
  resolveRequiredDeviceRole = function (opts) {
