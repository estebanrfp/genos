...
export function shouldRegisterPrimarySubcommand(argv) {
...
export function shouldEnsureCliPath(argv) {
...
export async function runCli(argv = process.argv) {
  ...
  process.on("uncaughtException", (error) => {
    ...
    if (msg.includes("Fatal Gateway error")) {
      console.error("[genosos] Discord gateway error (non-fatal):", msg);
      return;
    }
