let runModelsCommand = function (action) {
...
export function registerModelsCli(program) {
  const models = program
    ...
    .option("--agent <id>", "Agent id to inspect (overrides GENOS_AGENT_DIR/PI_CODING_AGENT_DIR)")
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/models", "docs.genos.ai/cli/models")}\n`,
    );
  models
    .command("list")
