let isValueToken = function (arg) {
  ...
  isNodeExecutable = function (executable) {
    return (
      executable === "node" ||
      executable === "node.exe" ||
      executable === "nodejs" ||
  ...
  isBunExecutable = function (executable) {
...
export function buildParseArgv(params) {
  ...
  return ["node", programName || "genosos", ...normalizedArgv];
}
