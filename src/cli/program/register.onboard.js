let resolveInstallDaemonFlag = function (command, opts) {
...
export function registerOnboardCommand(program) {
  const command = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/onboard", "docs.genos.ai/cli/onboard")}\n`,
    )
    .option("--workspace <dir>", "Agent workspace directory (default: ~/.genosv1/workspace)")
