...
${formatHelpExamples([
  ['genosos message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'genosos message send --target +15555550123 --message "Hi" --media photo.jpg',
  ...
  [
    'genosos message react --channel discord --target 123 --message-id 456 --emoji "\u2705"',
    "React to a message.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.genos.ai/cli/message")}`,
    )
    .action(() => {
