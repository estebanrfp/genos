...
describe("provider location helpers", () => {
  it("formats pin locations with accuracy", () => {
    ...
    expect(text).toBe("\uD83D\uDCCD 48.858844, 2.294351 \xB112m");
  });
  it("formats named places with address and caption", () => {
    ...
    expect(text)
      .toBe(`\uD83D\uDCCD Statue of Liberty \u2014 Liberty Island, NY (40.689247, -74.044502 \xB18m)
Bring snacks`);
  });
  it("formats live locations with live label", () => {
    ...
    expect(text).toBe(`\uD83D\uDEF0 Live location: 37.819929, -122.478255 \xB120m
On the move`);
  });
