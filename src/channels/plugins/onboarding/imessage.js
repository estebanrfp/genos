let setIMessageDmPolicy = function (cfg, dmPolicy) {
    const allowFrom =
  ...
  setIMessageAllowFrom = function (cfg, accountId, allowFrom) {
  ...
  parseIMessageAllowFromInput = function (raw) {
    return raw
      .split(/[\n,;]+/g)
  ...
  configure: async ({ cfg, prompter, accountOverrides, shouldPromptAccountIds }) => {
    ...
    await prompter.note(
      [
        ...
        "Ensure GenosOS has Full Disk Access to Messages DB.",
