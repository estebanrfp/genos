let makeCfg = function (storePath) {
    return {
      channels: { whatsapp: { allowFrom: ["*"] } },
      session: { store: storePath },
    };
  },
  makeReplyLogger = function () {
    return {
      warn: vi.fn(),
      info: vi.fn(),
      debug: vi.fn(),
  ...
  createHandlerForTest = function (opts) {
