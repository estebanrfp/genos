let unwrapMessage = function (message) {
  ...
  extractContextInfo = function (message) {
    if (!message) {
      return;
    }
  ...
  extractContactPlaceholder = function (rawMessage) {
  ...
  formatContactsPlaceholder = function (labels, total) {
  ...
  formatContactLabel = function (name, phones) {
  ...
  formatPhoneList = function (phones) {
  ...
  summarizeList = function (values, total, maxShown) {
