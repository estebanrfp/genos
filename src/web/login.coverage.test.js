...
describe("loginWeb coverage", () => {
  ...
  it("clears creds and throws when logged out", async () => {
    ...
    await expect(loginWeb(false, waitForWaConnectionMock)).rejects.toThrow(/cache cleared/i);
  ...
  it("formats and rethrows generic errors", async () => {
    ...
    await expect(loginWeb(false, waitForWaConnectionMock)).rejects.toThrow("formatted:Error: boom");
