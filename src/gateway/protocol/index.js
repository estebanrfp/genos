...
import {
  ...
  AgentsRenameParamsSchema,
  AgentsRenameResultSchema,
  ...
  AgentsFilesEditParamsSchema,
  AgentsFilesEditResultSchema,
...
import {
  ...
  AuthProfilesSetDisabledParamsSchema,
  AuthProfilesSetParamsSchema,
} from "./schema/auth-profiles.js";
import {
  CopilotLoginParamsSchema,
  CopilotLoginStatusParamsSchema,
  CopilotLoginCancelParamsSchema,
} from "./schema/providers-copilot-login.js";
import {
  ProvidersLoginParamsSchema,
  ProvidersLoginStatusParamsSchema,
  ProvidersLoginCancelParamsSchema,
} from "./schema/providers-login.js";
...
export const validateAgentsRenameParams = ajv.compile(AgentsRenameParamsSchema);
...
export const validateAgentsFilesEditParams = ajv.compile(AgentsFilesEditParamsSchema);
export const validateAgentsFilesDeleteParams = ajv.compile(AgentsFilesDeleteParamsSchema);
export const validateAuthProfilesSetParams = ajv.compile(AuthProfilesSetParamsSchema);
export const validateAuthProfilesDeleteParams = ajv.compile(AuthProfilesDeleteParamsSchema);
export const validateAuthProfilesSetDisabledParams = ajv.compile(
  AuthProfilesSetDisabledParamsSchema,
);
...
export const validateCopilotLoginParams = ajv.compile(CopilotLoginParamsSchema);
export const validateCopilotLoginStatusParams = ajv.compile(CopilotLoginStatusParamsSchema);
export const validateCopilotLoginCancelParams = ajv.compile(CopilotLoginCancelParamsSchema);
export const validateProvidersLoginParams = ajv.compile(ProvidersLoginParamsSchema);
export const validateProvidersLoginStatusParams = ajv.compile(ProvidersLoginStatusParamsSchema);
export const validateProvidersLoginCancelParams = ajv.compile(ProvidersLoginCancelParamsSchema);
