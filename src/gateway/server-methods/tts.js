  ...
  "tts.status": async ({ respond }) => {
    try {
      ...
      respond(true, {
        ...
        kokoroEnabled: isTtsProviderConfigured(config, "kokoro"),
        kokoroBaseUrl: config.kokoro.baseUrl,
        kokoroVoice: config.kokoro.voice,
        kokoroLang: config.kokoro.language ?? null,
      });
    } catch (err) {
    ...
    if (
      ...
      respond(
        ...
        errorShape(
          ...
          "Invalid provider. Use kokoro, openai, elevenlabs, or edge.",
        ),
      );
      return;
    }
        ...
        providers: [
          {
            id: "kokoro",
            name: "Kokoro TTS",
            configured: isTtsProviderConfigured(config, "kokoro"),
            models: ["kokoro"],
