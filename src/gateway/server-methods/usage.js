let resolveSessionUsageFileOrRespond = function (key, respond) {
  ...
  buildStoreBySessionId = function (store) {
...
const COST_USAGE_CACHE_TTL_MS = 30000;
...
const parseDateRange = (params) => {
  ...
  if (startMs !== undefined && endMs !== undefined) {
    return { startMs, endMs: endMs + 86400000 - 1 };
  }
  ...
  const defaultStartMs = todayStartMs - 2505600000;
...
export { parseDateRange, discoverAllSessionsForUsage, loadCostUsageSummaryCached };
export const __test = {
  parseDateToMs,
  parseDays,
  parseDateRange,
