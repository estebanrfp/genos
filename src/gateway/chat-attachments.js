let normalizeMime = function (mime) {
    if (!mime) {
      return;
    }
  ...
  isValidBase64 = function (value) {
    return value.length > 0 && value.length % 4 === 0 && /^[A-Za-z0-9+/]+={0,2}$/.test(value);
  },
  normalizeAttachment = function (att, idx, opts) {
  ...
  validateAttachmentBase64OrThrow = function (normalized, opts) {
