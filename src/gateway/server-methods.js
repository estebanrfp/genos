let authorizeGatewayMethod = function (method, client) {
  if (!client?.connect) {
    return null;
  }
...
import { copilotLoginHandlers } from "./server-methods/providers-copilot-login.js";
import { providersLoginHandlers } from "./server-methods/providers-login.js";
...
import { webauthnHandlers } from "./server-methods/webauthn.js";
...
const WRITE_METHODS = new Set([
  ...
  "providers.set",
  "providers.delete",
  "providers.setDisabled",
  "auth.profiles.set",
  "auth.profiles.delete",
  "auth.profiles.setDisabled",
  "webauthn.credential.remove",
  "webauthn.credential.rename",
  "providers.copilot.login",
  "providers.copilot.login.status",
  "providers.copilot.login.cancel",
  "providers.login",
...
export const coreGatewayHandlers = {
  ...
  ...voicewakeHandlers,
  ...healthHandlers,
  ...copilotLoginHandlers,
  ...providersLoginHandlers,
  ...channelsHandlers,
  ...chatHandlers,
  ...cronHandlers,
  ...deviceHandlers,
