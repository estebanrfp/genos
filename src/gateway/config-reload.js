...
const BASE_RELOAD_RULES_TAIL = [
  { prefix: "channels", kind: "hot", actions: [] },
  { prefix: "commands", kind: "none" },
  { prefix: "meta", kind: "none" },
  { prefix: "identity", kind: "none" },
  { prefix: "owner", kind: "none" },
...
export function buildGatewayReloadPlan(changedPaths) {
  ...
  // Invalidate cached rules to pick up any newly-loaded plugins
  cachedReloadRules = null;
