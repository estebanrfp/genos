let resolveChannelGroupConfig = function (groups, groupId, caseInsensitive = false) {
    if (!groups) {
      return;
    }
  ...
  normalizeSenderKey = function (value) {
  ...
  resolveChannelGroups = function (cfg, channel, accountId) {
