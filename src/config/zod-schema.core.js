...
// Credential entry inside providers[*].credentials
export const CredentialEntrySchema = z.union([
  z
    .object({
      id: z.string().min(1),
      type: z.literal("api_key"),
      key: z.string().min(1).register(sensitive),
  ...
  z
    .object({
      ...
      access: z.string().optional().register(sensitive),
      refresh: z.string().optional().register(sensitive),
      expires: z.number().optional(),
      email: z.string().optional(),
...
// Unified provider entry — credentials + endpoint config in one place
...
export const MarkdownConfigSchema = z
  ...
  .strict()
  .optional();
export const TtsProviderSchema = z.enum(["kokoro", "elevenlabs", "openai", "edge"]);
