let addAllowAlsoAllowConflictIssue = function (value, ctx, message) {
...
export const ToolProfileSchema = z
  ...
  .optional();
const ChannelRestrictionEntrySchema = z
  .object({
    deny: z.array(z.string()).optional(),
  })
  .strict();
const ChannelRestrictionsSchema = z.record(z.string(), ChannelRestrictionEntrySchema).optional();
...
const ToolExecBaseShape = {
  ...
  denyBins: z.array(z.string()).optional(),
...
const ToolLoopDetectionSchema = z
  ...
  .optional();
/** @deprecated Sandbox config removed — stub kept for backward compat (accepts & ignores). */
export const AgentSandboxSchema = z.record(z.string(), z.unknown()).optional();
export const AgentToolsSchema = z
  .object({
    ...
    channelRestrictions: ChannelRestrictionsSchema,
    elevated: z
      .object({
        enabled: z.boolean().optional(),
