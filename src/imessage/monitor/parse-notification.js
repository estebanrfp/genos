let isRecord = function (value) {
  ...
  isOptionalStringOrNumber = function (value) {
    return (
      value === undefined ||
      value === null ||
      typeof value === "string" ||
  ...
  isOptionalNumber = function (value) {
    return value === undefined || value === null || typeof value === "number";
  },
  isOptionalBoolean = function (value) {
    return value === undefined || value === null || typeof value === "boolean";
  },
  isOptionalStringArray = function (value) {
    return (
      value === undefined ||
      value === null ||
  ...
  isOptionalAttachments = function (value) {
