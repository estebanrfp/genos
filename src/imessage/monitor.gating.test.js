let baseCfg = function () {
  ...
  resolveDispatchDecision = function (params) {
  ...
  buildDispatchContextPayload = function (params) {
...
describe("imessage monitor gating + envelope builders", () => {
  ...
  it("blocks group messages when imessage.groups is set without a wildcard", () => {
    ...
    const decision = resolveIMessageInboundDecision({
      ...
      opts: {},
      messageText: "@genosos hello",
      bodyText: "@genosos hello",
      allowFrom: ["*"],
      groupAllowFrom: [],
      groupPolicy: "open",
      dmPolicy: "open",
