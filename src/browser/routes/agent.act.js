let resolveDownloadPathOrRespond = function (res, requestedPath) {
  ...
  buildDownloadRequestBase = function (cdpUrl, targetId, timeoutMs) {
    return {
      cdpUrl,
      targetId,
  ...
  respondWithDownloadResult = function (res, targetId, result) {
            ...
            if (fn && !evaluateEnabled) {
              return jsonError(
                ...
                [
                  ...
                  "Docs: /gateway/configuration#browser-genosos-managed-browser",
                ].join("\n"),
              );
            }
            if (
