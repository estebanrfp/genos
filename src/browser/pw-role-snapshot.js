let getIndentLevel = function (line) {
  ...
  matchInteractiveSnapshotLine = function (line, options) {
  ...
  createRoleNameTracker = function () {
  ...
  removeNthFromNonDuplicates = function (refs, tracker) {
  ...
  processLine = function (line, refs, options, tracker, nextRef) {
    const depth = getIndentLevel(line);
    if (options.maxDepth !== undefined && depth > options.maxDepth) {
      return null;
    }
  ...
  parseAiSnapshotRef = function (suffix) {
