...
let chromiumMock;
let snapshotAiViaPlaywright;
let clickViaPlaywright;
let closePlaywrightBrowserConnection;
beforeAll(async () => {
...
describe("pw-ai", () => {
  it("captures an ai snapshot via Playwright for a specific target", async () => {
    ...
    chromiumMock.connectOverCDP.mockResolvedValue(browser);
