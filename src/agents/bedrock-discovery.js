let normalizeProviderFilter = function (filter) {
  ...
  shouldIncludeSummary = function (summary, filter) {
  ...
  toModelDefinition = function (summary, defaults) {
