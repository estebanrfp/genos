let normalizeAvatarValue = function (value) {
    const trimmed = value?.trim();
    return trimmed ? trimmed : null;
  },
  resolveAvatarSource = function (cfg, agentId) {
  ...
  isRemoteAvatar = function (value) {
    const lower = value.toLowerCase();
    return lower.startsWith("http://") || lower.startsWith("https://");
  },
  isDataAvatar = function (value) {
    return value.toLowerCase().startsWith("data:");
  },
  resolveExistingPath = function (value) {
    try {
  ...
  isPathWithin = function (root, target) {
  ...
  resolveLocalAvatarPath = function (params) {
