let compactNotifyOutput = function (value, maxChars = DEFAULT_NOTIFY_SNIPPET_CHARS) {
  ...
  maybeNotifyOnExit = function (session, status) {
...
export const DEFAULT_PENDING_MAX_OUTPUT = clampWithDefault(
  readEnvInt("GENOS_BASH_PENDING_MAX_OUTPUT_CHARS"),
  30000,
  1000,
  200000,
);
...
export function renderExecHostLabel(host) {
  return host === "gateway" ? "gateway" : "node";
}
