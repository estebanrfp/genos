let supportsImageInput = function (modelId) {
  ...
  getDefaultContextWindow = function (modelId) {
    return MODEL_CONTEXT_WINDOWS[modelId] ?? 128000;
  },
  getDefaultMaxTokens = function (modelId) {
    return MODEL_MAX_TOKENS[modelId] ?? 8192;
  },
  buildModelDefinition = function (modelId) {
    return {
      id: modelId,
