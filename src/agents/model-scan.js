let normalizeCreatedAtMs = function (value) {
  ...
  parseModality = function (modality) {
    if (!modality) {
      return ["text"];
    }
  ...
  parseOpenRouterPricing = function (value) {
  ...
  isFreeOpenRouterModel = function (entry) {
  ...
  ensureImageInput = function (model) {
  ...
  buildOpenRouterScanResult = function (params) {
