...
describe("applyConfiguredContextWindows", () => {
  it("overrides discovered cache values with explicit models.providers contextWindow", () => {
    ...
    expect(cache.get("anthropic/claude-opus-4-6")).toBe(200000);
  });
    ...
    applyConfiguredContextWindows({
      ...
      modelsConfig: {
        providers: {
          openrouter: {
            models: [
              { id: "custom/model", contextWindow: 150000 },
              { id: "bad/model", contextWindow: 0 },
              { id: "", contextWindow: 300000 },
            ],
          },
        },
      },
    });
    expect(cache.get("custom/model")).toBe(150000);
