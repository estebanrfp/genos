let bumpVersion = function (current) {
    const now = Date.now();
  ...
  resolveWatchPaths = function (workspaceDir, config) {
    const paths = [];
  ...
  toWatchGlobRoot = function (raw) {
    return raw.replaceAll("\\", "/").replace(/\/+$/, "");
  },
  resolveWatchTargets = function (workspaceDir, config) {
...
import { clearSkillEntriesCache } from "./workspace.js";
