let extractBetween = function (input, startMarker, endMarker) {
  ...
  parseSkillBlocks = function (skillsPrompt) {
  ...
  buildInjectedWorkspaceFiles = function (params) {
  ...
  buildToolsEntries = function (tools) {
  ...
  extractToolListText = function (systemPrompt) {
