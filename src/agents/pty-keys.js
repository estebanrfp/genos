let encodeKeyToken = function (raw, warnings) {
  ...
  applyCharModifiers = function (char, mods) {
    let value = char;
  ...
  applyXtermModifier = function (sequence, modifier) {
  ...
  hasAnyModifier = function (mods) {
    return mods.ctrl || mods.alt || mods.shift;
  },
  parseHexByte = function (raw) {
