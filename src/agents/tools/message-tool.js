let actionNeedsExplicitTarget = function (action) {
    return EXPLICIT_TARGET_ACTIONS.has(action);
  },
  buildRoutingSchema = function () {
    return {
  ...
  buildSendSchema = function (options) {
    const props = {
  ...
  buildChannelTargetSchema = function () {
    return {
  ...
  buildThreadSchema = function () {
    return {
      threadName: Type.Optional(Type.String()),
      autoArchiveMin: Type.Optional(Type.Number()),
    };
  },
  buildEventSchema = function () {
    return {
  ...
  buildModerationSchema = function () {
    return {
      reason: Type.Optional(Type.String()),
      deleteDays: Type.Optional(Type.Number()),
    };
  },
  buildGatewaySchema = function () {
    return {
  ...
  buildChannelManagementSchema = function () {
    return {
  ...
  buildMessageToolSchemaProps = function (options) {
    return {
      ...buildRoutingSchema(),
  ...
  buildMessageToolSchemaFromActions = function (actions, options) {
  ...
  resolveMessageToolSchemaActions = function (params) {
  ...
  resolveIncludeComponents = function (params) {
    const currentChannel = normalizeMessageChannel(params.currentChannelProvider);
    if (currentChannel) {
  ...
  buildMessageToolSchema = function (params) {
    const currentChannel = normalizeMessageChannel(params.currentChannelProvider);
  ...
  resolveAgentAccountId = function (value) {
  ...
  filterActionsForContext = function (params) {
  ...
  buildMessageToolDescription = function (options) {
