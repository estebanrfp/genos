let createMockGateway = function (connected = true) {
  return { isConnected: connected, updatePresence: mockUpdatePresence };
};
...
const presenceEnabled = (key) => key === "presence";
const presenceDisabled = () => false;
