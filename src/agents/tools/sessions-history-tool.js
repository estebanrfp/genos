let truncateHistoryText = function (text) {
...
\u2026(truncated)\u2026`,
  ...
  sanitizeHistoryContentBlock = function (block) {
  ...
  sanitizeHistoryMessage = function (message) {
  ...
  enforceSessionsHistoryHardCap = function (params) {
