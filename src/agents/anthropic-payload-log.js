let resolvePayloadLogConfig = function (env) {
    const enabled = parseBooleanValue(env.GENOS_ANTHROPIC_PAYLOAD_LOG) ?? false;
    const fileOverride = env.GENOS_ANTHROPIC_PAYLOAD_LOG_FILE?.trim();
  ...
  isAnthropicModel = function (model) {
    return model?.api === "anthropic-messages";
  },
  findLastAssistantUsage = function (messages) {
