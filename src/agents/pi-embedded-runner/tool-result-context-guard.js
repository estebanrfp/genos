let isTextBlock = function (block) {
  ...
  isToolResultMessage = function (msg) {
    const role = msg.role;
    const type = msg.type;
    return role === "toolResult" || role === "tool" || type === "toolResult";
  },
  getToolResultContent = function (msg) {
  ...
  estimateMessageChars = function (msg) {
  ...
  truncateTextToBudget = function (text, maxChars) {
  ...
  replaceToolResultText = function (msg, text) {
    const content = msg.content;
  ...
  truncateToolResultToChars = function (msg, maxChars) {
    if (!isToolResultMessage(msg)) {
      return msg;
    }
  ...
  compactExistingToolResultsInPlace = function (params) {
  ...
  applyMessageMutationInPlace = function (target, source) {
    if (target === source) {
      return;
    }
  ...
  enforceToolResultContextBudgetInPlace = function (params) {
