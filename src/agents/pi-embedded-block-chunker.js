let findSafeSentenceBreakIndex = function (text, fenceSpans, minChars) {
  ...
  findSafeParagraphBreakIndex = function (params) {
  ...
  findSafeNewlineBreakIndex = function (params) {
    const { text, fenceSpans, minChars, reverse } = params;
  ...
  findNextParagraphBreak = function (buffer, fenceSpans, startIndex = 0) {
    if (startIndex < 0) {
      return null;
    }
    const re = /\n[\t ]*\n+/g;
