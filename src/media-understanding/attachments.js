let normalizeAttachmentPath = function (raw) {
  ...
  orderAttachments = function (attachments, prefer) {
...
export class MediaAttachmentCache {
  ...
  async getPath(params) {
    ...
    const tmpPath = path.join(os.tmpdir(), `genosos-media-${crypto.randomUUID()}${extension}`);
