let stripQuotes = function (value) {
    if (
  ...
  coerceFrontmatterValue = function (value) {
  ...
  parseYamlFrontmatter = function (block) {
    try {
  ...
  extractMultiLineValue = function (lines, startIndex) {
  ...
  parseLineFrontmatter = function (block) {
    const frontmatter = {};
