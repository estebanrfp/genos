let hasGitWorkspace = function (workspaceDir) {
  ...
  resolveLocalPath = function (entry, workspaceDir, allowLocal) {
    if (!allowLocal) {
      return null;
    }
  ...
  addPluginLoadPath = function (cfg, pluginPath) {
  ...
  resolveInstallDefaultChoice = function (params) {
