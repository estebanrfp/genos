let providerAccountKey = function (provider, accountId) {
    return `${provider}:${accountId ?? DEFAULT_ACCOUNT_ID}`;
  },
  formatChannelAccountLabel = function (params) {
  ...
  formatProviderState = function (entry) {
  ...
  resolveDefaultAccountId = function (cfg, provider) {
  ...
  shouldShowProviderEntry = function (entry, cfg) {
  ...
  formatProviderEntry = function (entry) {
