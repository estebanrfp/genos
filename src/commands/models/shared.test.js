...
vi.mock("../../config/config.js", () => ({
  readConfigFileSnapshot: (...args) => mocks.readConfigFileSnapshot(...args),
  writeConfigFile: (...args) => mocks.writeConfigFile(...args),
}));
