let extractMessageId = function (payload) {
  ...
  renderObjectSummary = function (payload, opts) {
    if (!payload || typeof payload !== "object") {
  ...
  renderMessageList = function (messages, opts, emptyLabel) {
  ...
  renderMessagesFromPayload = function (payload, opts) {
    if (!payload || typeof payload !== "object") {
      return null;
    }
  ...
  renderPinsFromPayload = function (payload, opts) {
    if (!payload || typeof payload !== "object") {
      return null;
    }
  ...
  extractDiscordSearchResultsMessages = function (results) {
  ...
  renderReactions = function (payload, opts) {
    if (!payload || typeof payload !== "object") {
      return null;
    }
