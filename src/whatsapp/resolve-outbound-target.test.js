let expectResolutionError = function (params) {
  ...
  expectResolutionOk = function (params, expectedTarget) {
    const result = resolveWhatsAppOutboundTarget(params);
...
vi.mock("../infra/outbound/target-errors.js", () => ({
  missingTargetError: (platform, format) => new Error(`${platform}: ${format}`),
}));
