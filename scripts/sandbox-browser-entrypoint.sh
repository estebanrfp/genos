...
export DISPLAY=:1
export HOME=/tmp/genosos-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${GENOS_BROWSER_CDP_PORT:-9222}"
VNC_PORT="${GENOS_BROWSER_VNC_PORT:-5900}"
NOVNC_PORT="${GENOS_BROWSER_NOVNC_PORT:-6080}"
ENABLE_NOVNC="${GENOS_BROWSER_ENABLE_NOVNC:-1}"
HEADLESS="${GENOS_BROWSER_HEADLESS:-0}"
