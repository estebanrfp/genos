...
- Keep product names in English: GenosOS, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the GenosOS Gateway, use “Gateway 网关”.
