let replaceBlockLines = function (text, startMarker, endMarker, lines) {
  ...
  renderKimiK2Ids = function (prefix) {
    return MOONSHOT_KIMI_K2_MODELS.map((model) => `- \`${prefix}${model.id}\``);
  },
  renderMoonshotAliases = function () {
