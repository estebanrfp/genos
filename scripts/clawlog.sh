...
show_usage() {
    cat << EOF
clawlog - GenosOS Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View GenosOS logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    GenosOS logs flow through the macOS unified log (subsystem: ai.genos).
